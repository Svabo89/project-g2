...
public class Table {
  ...
  private List<Integer> nativeFieldsList = new ArrayList<>();
  private List<Integer> relatedTablesList = new ArrayList<>();
  private int[] nativeFields;
  private int[] relatedTables;
  private int[] relatedFields;
  private final Logger logger = Logger.getLogger(Table.class.getName());
  ...
  public Table(String inputString, boolean isConnector) {
    if (isConnector) {
      parseConnectorInput(inputString);
    } else {
      parseInput(inputString);
    }
  }
  ...
  private void parseConnectorInput(String inputString) {
    StringTokenizer st = new StringTokenizer(inputString, "|");
    try {
